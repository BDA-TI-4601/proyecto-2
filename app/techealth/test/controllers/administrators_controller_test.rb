...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { amount: @administrator.amount, price: @administrator.price, treatment: @administrator.treatment } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { amount: @administrator.amount, price: @administrator.price, treatment: @administrator.treatment } }
